...
const About = () => {
  return (
    <section class="text-gray-600 body-font lg:mt-44">
      <h1 className="text-sky-500 text-center text-5xl font-bold">ABOUT US</h1>
      ...
      <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <div class="mt-20 lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <p class="mt-5 leading-relaxed text-white text-lg">
            ...
            we've built a dynamic platform that simplifies business card storage
            and access. Our journey is rooted in making networking effortless
            and efficient, empowering you to connect, engage, and grow your
            professional relationships with ease.
          </p>
        </div>
      </div>
    </section>
