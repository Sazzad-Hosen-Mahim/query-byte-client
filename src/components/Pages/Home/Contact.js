...
const Contact = () => {
  return (
    <section class="text-gray-600 body-font relative lg:mt-44">
      <h1 className="text-5xl text-sky-500 text-center font-bold">
        CONTACT US
      </h1>
      ...
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-12">
          <p class="lg:w-2/3 mx-auto leading-relaxed text-white">
            Feel free to contact us for any issues or any queries. Thank you.
          </p>
        </div>
